...
**[Decode Morse Message]** is a program that help you to decode Morse code messages.
...
```sh
  cd my-folder
  git clone git@github.com:mperezbazan/decode_morse_message.git
```
